...
import { getYesterdayRange } from '../utils/timeRangeGenerator.js';
...
export const options = {
  ...
  tags: {
    name: 'Yesterday with User Query',
...
// Function to generate a payload with yesterday time range and user
function generatePayload() {
  // Get dynamic time range for yesterday
...
export default function() {
  ...
  // Generate the payload with yesterday time range and user
